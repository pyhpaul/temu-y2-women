# concept-feedback-loop Specification

## Purpose
Define the stable contract for capturing reviewed `dress` concept feedback and deterministically applying bounded score updates, ledger records, and reports back into active evidence.
## Requirements
